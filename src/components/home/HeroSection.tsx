        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0 bg-stone-900">
                    ...
                    <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-green-900/40 rounded-full blur-[120px] mix-blend-screen" />
                    <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-amber-900/30 rounded-full blur-[100px] mix-blend-screen" />
            ...
            <div className="container relative z-20 px-4 mx-auto text-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                        <Button asChild size="lg" className="h-14 px-10 text-lg rounded-full bg-emerald-600 hover:bg-emerald-500 text-white border-0 shadow-lg shadow-emerald-900/20 hover:scale-105 transition-all duration-300">
                            <Link href="/analysis">
